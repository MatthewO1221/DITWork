...
{
	NewTile(allTiles, TILE_AIR,					PAINT_NONE,		0, 0, 0, NULL,															NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
	NewTile(allTiles, TILE_GROUND,				PAINT_NONE,		0, 0, 1, AEGfxTextureLoad("./Assets/Tiles/ground.png"),				NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
	NewTile(allTiles, TILE_SOLID_WATER,			PAINT_BLUE,		0, 0, 0, AEGfxTextureLoad("./Assets/Tiles/solid_water.png"),			NULL, NULL, NULL, NULL, NULL, NULL, ToIce, NULL);
	NewTile(allTiles, TILE_FLOOR_SPIKES,		PAINT_NONE,		0, 0, 0, AEGfxTextureLoad("./Assets/Tiles/floor_spikes.png"),			NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
	NewTile(allTiles, TILE_DOTTED_BLOCK,		PAINT_RED,		0, 0, 0, AEGfxTextureLoad("./Assets/Tiles/dotted_block.png"),			NULL, NULL, NULL, NULL, NULL, NULL, ToFilledBlock, NULL);
	NewTile(allTiles, TILE_VINE_STEM,			PAINT_GREEN,	0, 0, 0, AEGfxTextureLoad("./Assets/Tiles/vine_stem.png"),				NULL, NULL, NULL, NULL, NULL, NULL, GrowVine, NULL);
	NewTile(allTiles, TILE_BATTERY,				PAINT_NONE,		0, 0, 1, AEGfxTextureLoad("./Assets/Tiles/battery.png"),				NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
	NewTile(allTiles, TILE_POWERED_DOOR_OFF,	PAINT_NONE,		0, 0, 1, AEGfxTextureLoad("./Assets/Tiles/powered_door_off.png"),		NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
	NewTile(allTiles, TILE_GEM,					PAINT_NONE,		0, 0, 0, AEGfxTextureLoad("./Assets/Tiles/gem.png"),					NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
	NewTile(allTiles, TILE_SAPLING,				PAINT_GREEN,	0, 0, 0, AEGfxTextureLoad("./Assets/Tiles/sapling.png"),				NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
	NewTile(allTiles, TILE_ICE,					PAINT_NONE,		0, 0, 1, AEGfxTextureLoad("./Assets/Tiles/ice.png"),					NULL, NULL, ToSolidWater, NULL, NULL, NULL, NULL, NULL);
	NewTile(allTiles, TILE_FILLED_BLOCK,		PAINT_NONE,		0, 0, 1, AEGfxTextureLoad("./Assets/Tiles/filled_block.png"),			NULL, NULL, ToDottedBlock, NULL, NULL, NULL, NULL, NULL);
	NewTile(allTiles, TILE_RED_PAINT_UNLOCK,	PAINT_NONE,		0, 0, 0, AEGfxTextureLoad("./Assets/Tiles/red_paint_unlock.png"),		NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
	NewTile(allTiles, TILE_UPGRADE_PART,		PAINT_NONE,		0, 0, 0, AEGfxTextureLoad("./Assets/Tiles/upgrade_part.png"),			NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
	NewTile(allTiles, TILE_WOOD,				PAINT_NONE,		0, 0, 1, AEGfxTextureLoad("./Assets/Tiles/wood.png"),					NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
	NewTile(allTiles, TILE_GREEN_SLIME_SPAWN,	PAINT_NONE,		0, 0, 0, AEGfxTextureLoad("./Assets/Tiles/green_slime_spawn.png"),		SpawnSlime, NULL, UndoSpawnSlime, NULL, NULL, NULL, NULL, NULL);
	NewTile(allTiles, TILE_CHECKPOINT,			PAINT_NONE,		0, 0, 0, AEGfxTextureLoad("./Assets/Tiles/checkpoint.png"),			NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
	NewTile(allTiles, TILE_CLOUD,				PAINT_NONE,		0, 0, 1, AEGfxTextureLoad("./Assets/Tiles/cloud.png"),					NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
	NewTile(allTiles, TILE_DOTTED_CHECKPOINT,	PAINT_RED,		0, 0, 0, AEGfxTextureLoad("./Assets/Tiles/dotted_checkpoint.png"),		NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
	NewTile(allTiles, TILE_DOTTED_GEM,			PAINT_RED,		0, 0, 0, AEGfxTextureLoad("./Assets/Tiles/dotted_gem.png"),			NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
	NewTile(allTiles, TILE_RED_EASEL,			PAINT_RED,		0, 0, 0, AEGfxTextureLoad("./Assets/Tiles/red_easel.png"),				NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
	NewTile(allTiles, TILE_GROWN_FLOWERS,		PAINT_NONE,		0, 0, 0, AEGfxTextureLoad("./Assets/Tiles/grown_flowers.png"),			NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
	NewTile(allTiles, TILE_FLOWING_WATER,		PAINT_BLUE,		0, 0, 0, AEGfxTextureLoad("./Assets/Tiles/flowing_water.png"),			NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
	NewTile(allTiles, TILE_KNIGHT_SPAWN,		PAINT_NONE,		0, 0, 0, AEGfxTextureLoad("./Assets/Tiles/knight_spawn.png"),			NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
	NewTile(allTiles, TILE_LEAF_BLOCK,			PAINT_NONE,		0, 0, 1, AEGfxTextureLoad("./Assets/Tiles/leaf_block.png"),			NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
	NewTile(allTiles, TILE_POWER_SWITCH_ON,		PAINT_NONE,		0, 0, 1, AEGfxTextureLoad("./Assets/Tiles/power_switch_on.png"),		NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
	NewTile(allTiles, TILE_POWER_SWITCH_OFF,	PAINT_NONE,		0, 0, 1, AEGfxTextureLoad("./Assets/Tiles/power_switch_off.png"),		NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
	NewTile(allTiles, TILE_POWERED_DOOR_ON,		PAINT_NONE,		0, 0, 0, AEGfxTextureLoad("./Assets/Tiles/powered_door_on.png"),		NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
	NewTile(allTiles, TILE_BLUE_SLIME_SPAWN,	PAINT_NONE,		0, 0, 0, AEGfxTextureLoad("./Assets/Tiles/blue_slime_spawn.png"),		NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
	NewTile(allTiles, TILE_YELLOW_SLIME_SPAWN,	PAINT_NONE,		0, 0, 0, AEGfxTextureLoad("./Assets/Tiles/yellow_slime_spawn.png"),	NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
	NewTile(allTiles, TILE_PURPLE_SLIME_SPAWN,	PAINT_NONE,		0, 0, 0, AEGfxTextureLoad("./Assets/Tiles/purple_slime_spawn.png"),	NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
	NewTile(allTiles, TILE_GREEN_EASEL,			PAINT_GREEN,	0, 0, 0, AEGfxTextureLoad("./Assets/Tiles/green_easel.png"),			NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
	NewTile(allTiles, TILE_YELLOW_EASEL,		PAINT_YELLOW,	0, 0, 0, AEGfxTextureLoad("./Assets/Tiles/yellow_easel.png"),			NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
	NewTile(allTiles, TILE_BLUE_EASEL,			PAINT_BLUE,		0, 0, 0, AEGfxTextureLoad("./Assets/Tiles/blue_easel.png"),			NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
	NewTile(allTiles, TILE_ORANGE_EASEL,		PAINT_ORANGE,	0, 0, 0, AEGfxTextureLoad("./Assets/Tiles/orange_easel.png"),			NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
	NewTile(allTiles, TILE_PURPLE_EASEL,		PAINT_PURPLE,	0, 0, 0, AEGfxTextureLoad("./Assets/Tiles/purple_easel.png"),			NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
	NewTile(allTiles, TILE_CEILING_SPIKES,		PAINT_NONE,		0, 0, 0, AEGfxTextureLoad("./Assets/Tiles/ceiling_spikes.png"),		NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
	NewTile(allTiles, TILE_SNOW_BLOCK,			PAINT_NONE,		0, 0, 0, AEGfxTextureLoad("./Assets/Tiles/snow_block.png"),			NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
	NewTile(allTiles, TILE_STALACTITE,			PAINT_NONE,		0, 1, 0, AEGfxTextureLoad("./Assets/Tiles/stalactite.png"),			NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
	NewTile(allTiles, TILE_UNGROWN_FLOWER,		PAINT_GREEN,	0, 0, 0, AEGfxTextureLoad("./Assets/Tiles/ungrown_flowers.png"),		NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
	NewTile(allTiles, TILE_STALACTITE_TRIGGER,	PAINT_BLUE,		0, 0, 0, AEGfxTextureLoad("./Assets/Tiles/stalactite_trigger.png"),	TriggerDespawn, NULL, TriggerStalactiteSpawn, DropStalactite, NULL, NULL, DropStalactite, NULL);
	NewTile(allTiles, TILE_WALL_SPIKES_LEFT,	PAINT_NONE,		0, 0, 0, AEGfxTextureLoad("./Assets/Tiles/wall_spikes_left.png"),		NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
	NewTile(allTiles, TILE_WALL_SPIKES_RIGHT,	PAINT_NONE,		0, 0, 0, AEGfxTextureLoad("./Assets/Tiles/wall_spikes_right.png"),		NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
	NewTile(allTiles, TILE_VINE_PATH,			PAINT_NONE,		0, 0, 0, AEGfxTextureLoad("./Assets/Tiles/vine_path.png"),				TriggerDespawn, NULL, TriggerVinePathSpawn, NULL, NULL, NULL, NULL, NULL);
	NewTile(allTiles, TILE_VINE_BLOCK,			PAINT_NONE,		0, 0, 1, AEGfxTextureLoad("./Assets/Tiles/vine_block.png"),			NULL, NULL, ToVinePath, NULL, NULL, NULL, NULL, NULL);
	NewTile(allTiles, TILE_EYEBAT_SPAWN,		PAINT_NONE,		0, 0, 0, AEGfxTextureLoad("./Assets/Tiles/eyebat_spawn.png"),			NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
	NewTile(allTiles, TILE_CRATE,				PAINT_NONE,		0, 1, 1, AEGfxTextureLoad("./Assets/Tiles/crate.png"),					NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
}
...
void TileToScreenPos(unsigned char tilePosX, unsigned char tilePosY, long *screenPosX, long *screenPosY)
{
	...
	*screenPosX = (long)(tilePosX * TILE_SIZE) - 704;
...
void InitPlaymodeLevel(GameplayInstance *instance)
{
	...
	for (int y = 0; y < TILEMAP_HEIGHT; ++y)
	{
		...
		for (int x = 0; x < TILEMAP_WIDTH; ++x)
		{
			if (instance->level->tilemap->tiles[x][y]->id == TILE_GROUND)
			{
				instance->tileCollisions[x][y] = FromPoints(
					(float)x * TILE_SIZE - 704,
					(float)x * TILE_SIZE + TILE_SIZE - 704,
					(float)y * -TILE_SIZE + 384,
					(float)y * -TILE_SIZE + TILE_SIZE + 384);
			}
			else
			{
				instance->tileCollisions[x][y] = NULL;
			}
...
void ShutdownPlaymodeLevel(GameplayInstance* instance)
{
	...
	for (int y = 0; y < TILEMAP_HEIGHT; ++y)
	{
		...
		for (int x = 0; x < TILEMAP_WIDTH; ++x)
		{
			...
			FreeAABB(instance->tileCollisions[x][y]);
		}
	}
}
...
void SpawnSlime(GameplayInstance* game, unsigned char tileX, unsigned char tileY)
{
	game->level->tilemap->tiles[tileX][tileY] = &game->allTiles[TILE_AIR];

	long enemyX, enemyY;
	TileToScreenPos(tileX, tileY, &enemyX, &enemyY);
	Vector2D spawnPos = { (float)enemyX, (float)enemyY };

	SpawnEnemy(0, 3, spawnPos, "Green Slime");
}
void UndoSpawnSlime(GameplayInstance* game, unsigned char tileX, unsigned char tileY)
{
	game->level->tilemap->tiles[tileX][tileY]->texture = AEGfxTextureLoad("./Assets/Tiles/green_slime_spawn.png");

	//DespawnEnemies(enemyList);
}

AABB* GetTileColliders(GameplayInstance* game)
{
	return *game->tileCollisions;
}