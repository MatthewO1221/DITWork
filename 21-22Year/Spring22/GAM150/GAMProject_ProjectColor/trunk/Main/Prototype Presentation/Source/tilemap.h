...
#define TILE_SIZE 64
#define TILEMAP_WIDTH 99 // 100
#define TILEMAP_HEIGHT 59 // 60
#define PIXELS_PER_TILE 16
#define TILE_COUNT 46
#define MAX_TILE_ENTITIES 16
#define MIN_AREA_WIDTH 19 // 20
#define MIN_AREA_HEIGHT 11 // 12
...
typedef struct Tile
{
	...
	// Whether or not the tile is collidable.
...
typedef struct Tilemap
{
	...
	struct Tile* tiles[TILEMAP_WIDTH][TILEMAP_HEIGHT];
} Tilemap;
...
typedef struct GameplayInstance
{
	...
	AABB tileCollisions[TILEMAP_WIDTH][TILEMAP_HEIGHT];
} GameplayInstance;

Tile NewTile(Tile[], unsigned char, enum PaintColor, unsigned char, unsigned char, unsigned char, AEGfxTexture*, TileInfoFunctionPtr, TileInfoFunctionPtr, TileInfoFunctionPtr, TileInfoFunctionPtr, TileInfoFunctionPtr, TileInfoFunctionPtr, TileInfoFunctionPtr, TileInfoFunctionPtr);
...
void SpawnSlime(GameplayInstance*, unsigned char, unsigned char);
void UndoSpawnSlime(GameplayInstance*, unsigned char, unsigned char);
AABB* GetTileColliders(GameplayInstance*);
