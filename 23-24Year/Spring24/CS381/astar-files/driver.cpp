...
struct Test0Edge
{
    Test0Edge(size_t id1, size_t id2, float weight) : id1(id1), id2(id2), weight(weight) {}
...
public:
    ...
    Callback3(GraphType const &_g, char const *bmp_filename) : Callback<GraphType, AstarType>(_g),
