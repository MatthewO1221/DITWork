...
void test0()
{
    ...
    if (kb.ProveByRefutation(alpha))
    {
        std::cout << "Proved" << std::endl;
    }
    else
    {
        std::cout << "Not proved" << std::endl;
    }
}
...
////////////////////////////////////////////////////////////////////////////////
void test9()
{ // only USEFUL rules are inserted
    test4();
    test5();
...
////////////////////////////////////////////////////////////////////////////////
void test10()
{ // a little more rules are inserted
    test4();
    test5();
    ...
    for (int x = 0; x < 4; ++x)
    {
        for (int y = 0; y < 4; ++y)
        {
            if ((x != 1 || y != 2) && (x != 0 || y != 2) && (x != 2 || y != 2) && (x != 1 || y != 1))
                continue;
